...
- **Nodemailer (`nodemailer`)**: A module for sending emails from Node.js. It performs critical automated tasks like dispatching registration confirmations, OTPs, or event tickets directly to users' inboxes. (Note: Kept Nodemailer as I wasn't able to log in to SendGrid).
